...
- name: KESSEL_AUTH_OIDC_ISSUER
  value: {{ include "cost-onprem.keycloak.issuerUrl" . | quote }}
- name: KESSEL_AUTH_TOKEN_URL
  value: {{ printf "http://keycloak-service.%s.svc.cluster.local:8080/realms/%s/protocol/openid-connect/token" (.Values.jwtAuth.keycloak.namespace | default "keycloak") (.Values.jwtAuth.keycloak.realm | default "kubernetes") | quote }}
